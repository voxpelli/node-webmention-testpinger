...
const getURL = (query) => 'http://' + host + ':' + port + '/template?' + qs.stringify(query);
...
const options = noptify(process.argv, { program: 'webmention-testpinger' })
